  ...
  <div id="MobileNarbarModal" ref="MobileNarbarModal" class="modal fade text-center animate__animated animate__bounceIn" tabindex="-1" aria-labelledby="MobileNarbarModalLabel"
      ...
      <div class="modal-dialog modal-fullscreen bg-primary">
        ...
        <ul class="w-100 h-100 list-unstyled d-flex flex-column justify-content-center align-items-center text-light">
          <li class="nav-item bg-transparent mb-3">
            <RouterLink to="/home" class="Logo navbar-brand" data-bs-dismiss="modal">
          ...
          <hr class="bg-dark">
          <li class="nav-item bg-transparent mb-3">
            <RouterLink to="/home" class="nav-link fs-4" data-bs-dismiss="modal">首頁
          ...
          <hr class="bg-light">
          <li class="nav-item  bg-transparent mb-3">
            <RouterLink to="/products" class="nav-link py-auto fs-4" data-bs-dismiss="modal">產品列表
          ...
          <hr class="bg-light">
          <li class="nav-item  bg-transparent mb-3">
            <RouterLink to="/cart" class="nav-link py-auto position-relative fs-4" data-bs-dismiss="modal">購物車
          ...
          <hr class="bg-light">
          <li class="nav-item bg-transparent mb-3">
            <RouterLink to="/login" class="nav-link fs-4" data-bs-dismiss="modal">登入
