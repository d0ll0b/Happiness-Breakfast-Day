<template>
    <ul class="nav narbar w-100 bg-primary text-white fw-bold px-2 justify-content-between z-3 top-0 end-0">
        <div>
        ...
        <div class="d-flex pe-3 justify-content-end justify-content-lg-between">
            <li class="nav-item ms-4 my-auto d-none d-lg-block">
                <RouterLink to="/home" class="nav-link">首頁
            ...
            <li class="nav-item ms-4 my-auto d-none d-lg-block">
                <RouterLink to="/products" class="nav-link py-auto">產品列表
            ...
            <li class="nav-item ms-4 my-auto d-none d-lg-block">
                <RouterLink to="/login" class="nav-link">登入
            ...
            <!-- offcanvas -->
            <li class="nav-item ms-4 my-auto d-block d-lg-none">
