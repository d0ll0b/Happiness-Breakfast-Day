<template>
    <ul class="nav bg-primary text-white fw-bold px-2 justify-content-between sticky-top">
        ...
        <div class="d-flex pe-3 justify-content-end justify-content-lg-between">
            ...
            <li class="nav-item ms-4 my-auto d-none d-lg-block">
                <RouterLink to="/products" class="nav-link py-auto header-item">美味餐點
            ...
            <li class="nav-item ms-4 my-auto d-none d-lg-block">
                <RouterLink to="/cart" class="nav-link py-auto position-relative header-item">購物車
                    ...
                    <span class="position-absolute top-25 start-20 translate-middle badge rounded-pill bg-secondary" v-show="this.carts?.length">
                        {{ this.carts?.length }}
                    </span>
                </RouterLink>
            </li>
            ...
            <!-- offcanvas -->
            <li class="nav-item ms-4 my-auto header-item d-block d-lg-none">
