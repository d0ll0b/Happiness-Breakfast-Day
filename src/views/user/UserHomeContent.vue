<template>
  ...
  <div class="container-fuild bg-primary">
    ...
    <ul class="d-flex justify-content-evenly text-light mt-4 mb-0 ps-0 py-auto">
      <li class="d-flex flex-column align-items-center shake-slow">
        <div class="cart-start">
          <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-clipboard-check" viewBox="0 0 16 16">
      ...
      <li class="d-flex flex-column align-items-center shake-slow">
        <div class="card-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-alarm" viewBox="0 0 16 16">
