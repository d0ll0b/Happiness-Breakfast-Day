<template>
  ...
  <div class="container-fuild">
    ...
    <div class="w-100 description text-white d-flex flex-column justify-content-between py-7">
      ...
      <h2 class="description-text" data-aos="fade-down-right">
        我們的餐廳是幸福和美味的結合，<br />是您開啟一天的幸福之旅的最佳起點。
      </h2>
      <br /><br />
      <h2
        class="description-text d-none d-sm-block"
        data-aos="fade-down-left"
        data-animation="fadeInDown"
      >
        無論您是想要輕鬆享受一頓早餐還是慶祝特殊時刻，<br />我們都能為您打造一個充
        滿幸福的用餐體驗。
      </h2>
      <div class="down-arrow mt-4 mx-auto animate__animated animate__fadeInDown animate__infinite">
        <svg
          ...
          height="40"
          fill="currentColor"
          class="bi bi-chevron-double-downn"
          viewBox="0 0 16 16"
        >
          <path
            fill-rule="evenodd"
  ...
  <div class="container-fuild bg-primary">
        ...
        <div class="col pb-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <div>
                <button
                  class="btn btn-secondary mt-2 text-light"
                  type="button"
                  @click="add_cart(item.id, 1, 'new')"
                >
                  加入購物車
                </button>
              </div>
    ...
    <ul class="d-flex justify-content-evenly text-light mt-4 mb-0 ps-0 py-auto">
      <li class="d-flex flex-column align-items-center shake-slow" data-aos="fade-up">
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            class="bi bi-clipboard-check order-process-svg"
            viewBox="0 0 16 16"
          >
            <path
              fill-rule="evenodd"
      ...
      <li
        class="d-md-flex d-none flex-column justify-content-center animate__animated animate__fadeInLeft animate__infinite"
      >
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <li
        class="d-flex flex-column align-items-center shake-slow"
        data-aos="fade-up"
      ...
      >
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            class="bi bi-alarm order-process-svg"
            viewBox="0 0 16 16"
          >
            <path
      ...
      >
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            class="bi bi-box-seam order-process-svg"
            viewBox="0 0 16 16"
          >
            <path
      ...
      <div class="col-8">
        ...
        <ul v-for="item in articles" :key="item.id" class="w-100">
          <li class="d-flex">
            ...
            <span
              class="col-7 border border-4 border-primary bg-primary text-light px-2 d-flex h5 text-start align-items-center"
              >&emsp;&emsp;{{ item.description }}</span
            >
            <RouterLink
              to="/products"
              class="col-1 text-end header-item py-1 bg-primary text-light fs-5"
              >more</RouterLink
            >
          </li>
        </ul>
  ...
  <div class="container-fuild">
    ...
    <div class="d-flex bg-light flex-column flex-sm-row">
      <div
        class="col-12 col-sm-4 flex-column text-start justify-content-around py-3"
        data-aos="fade-right"
      >
        <ul>
          <h3 class="text-primary mt-3">店鋪資訊</h3>
          <br />
          <h4>太平洋店</h4>
          <br />
          <li><span class="h6">地址: </span>太平洋</li>
          <br />
          營業時間:
      ...
      <div class="col-12 col-sm-8">
        <iframe
          data-aos="fade-up"
          src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3702.747379850056!2d-133.4193056!3d-21.8672778!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjHCsDUyJzAyLjIiUyAxMzPCsDI1JzA5LjUiVw!5e0!3m2!1szh-TW!2stw!4v1711270962625!5m2!1szh-TW!2stw"
          style="border: 0"
          allowfullscreen=""
          loading="lazy"
