<template>
    ...
    <div class="container">
        ...
        <div class="my-5 mt-4 row justify-content-center">
            ...
            <v-form ref="form" class="col-md-6 mt-4" v-slot="{ errors }" @submit="onSubmit" >
              <div class="mb-3">
              ...
              <div class="mb-3">
                  ...
                  <textarea id="message" class="form-control border-primary" cols="30" rows="10" v-model="form.message"></textarea>
              </div>
              <div class="text-end">
                  <button type="submit" class="btn btn-primary" :class="{ 'disabled': Object.keys(errors).length !== 0 || !carts.length }"
                          >送出訂單</button>
              </div>
            </v-form>
        </div>
